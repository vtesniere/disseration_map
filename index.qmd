...
4.  The fourth illustrate KDE Zero-shot historical examples, with data from 1995 and 2015 with the wish to show the evolution of these areas over time. This is a work in progress but aims to illustrate the temporal importance when defining a neighbourhood
